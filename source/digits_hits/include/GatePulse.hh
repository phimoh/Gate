...
public:
    ...
    inline G4double GetEnergyInBGO()   const                  	      { return m_bgo_energy; }
    inline void SetEnergyInBGO(G4double value)           	      { m_bgo_energy = value; }

    inline G4double GetEnergyInPlstc()   const                  	      { return m_plstc_energy; }
    inline void SetEnergyInPlstc(G4double value)           	      { m_plstc_energy = value; }
...
private:
  ...
  G4double m_bgo_energy = 0.0;
  G4double m_plstc_energy = 0.0;
#ifdef GATE_USE_OPTICAL
